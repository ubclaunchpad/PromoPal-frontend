...
export async function getRestaurant(restaurantId: string): Promise<Place> {
  ...
  return {
    address_components: [
      {
        long_name: '7235',
        short_name: '7235',
        types: [GeocodingAddressComponentType.street_number],
      },
      {
      ...
      },
      {
        long_name: 'Burnaby',
        short_name: 'Burnaby',
        types: [AddressType.locality, AddressType.political],
      },
      {
        long_name: 'Metro Vancouver',
        short_name: 'Metro Vancouver',
        types: [AddressType.administrative_area_level_2, AddressType.political],
      },
      {
    ...
    place_id: 'ChIJb0n5cWl3hlQRIbVGYLiTEgE',
    plus_code: {
    ...
    reviews: [
      {
        ...
        author_url: 'https://www.google.com/maps/contrib/106791507496093347654/reviews',
        language: 'en',
        profile_photo_url:
      ...
      {
        author_name: 'S J',
        author_url: 'https://www.google.com/maps/contrib/106030359247950017747/reviews',
        language: 'en',
        profile_photo_url:
      ...
      },
      {
        ...
        author_url: 'https://www.google.com/maps/contrib/115629718177213111074/reviews',
        language: 'en',
        profile_photo_url:
      ...
      },
      {
        ...
        author_url: 'https://www.google.com/maps/contrib/105237780839206869607/reviews',
        language: 'en',
        profile_photo_url:
      ...
      },
      {
        ...
        author_url: 'https://www.google.com/maps/contrib/105476603778596274534/reviews',
        language: 'en',
        profile_photo_url:
