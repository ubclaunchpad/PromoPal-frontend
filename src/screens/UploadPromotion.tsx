...
export default function UploadPromotion(): ReactElement {
  ...
  const categoryTypeOptions = ['Happy Hour', '10% off', '25% off', '50% off', 'BOGO'];
  ...
  return (
    <div style={styles.container}>
      ...
      >
        ...
        >
          <Input placeholder="e.g. 10% off Happy Hour Menu" autoComplete="off" />
        </Form.Item>
        ...
        <Form.Item
          ...
          name="restaurantName"
          labelAlign="left"
          rules={[{ required: true, message: "Please input the restaurant's name!" }]}
          style={styles.formItem}
        >
